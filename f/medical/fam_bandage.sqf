...
private _bdgProg = "alive _target && _this distance _target < 3 && _target getVariable ['FAM_BLEED',false]"; // This one is always the same, start condition varies by unit type.
